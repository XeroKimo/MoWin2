...
//
//    public:
//        Window(WindowStyleEx extendedStyle, string_type windowName, WindowStyle style, int x, int y, int width, int height, HWND optionalParent, HMENU menu, HINSTANCE hInstance)
//        {
...
//        }
//
//        Window(string_type windowName, WindowStyle style, int x, int y, int width, int height, HWND optionalParent, HMENU menu, HINSTANCE hInstance) :
//            Window(WindowStyleEx{ 0 }, windowName, style, x, y, width, height, optionalParent, menu, hInstance)
//        {
//
//        }
//
